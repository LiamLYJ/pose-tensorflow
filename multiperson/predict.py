...
def eval_graph(sm, detections):
    ...
    if unary_array.shape[0] > 0:
        ...
        # print ('the return of slove_nl_lmp',res)
    ...
    # print ('unLab:',unLab)
    # print ('shape of unLab',unLab.shape)
    #
    # print ('pos_array:', pos_array)
    # print ('unary_array:,',unary_array)
    # print ('pwidx_array:,',pwidx_array)
    # print ('pw_array:,',pw_array)
...
def get_person_conf_multicut(sm, unLab, unary_array, pos_array):
    ...
    # print ('shape of unary_array:',unary_array.shape)
    # print (unary_array)
    # print ('shape of unLab:',unLab.shape)
    # raise
    ...
    # print ('shape of person_conf:',person_conf.shape)
    # raise
    return person_conf
